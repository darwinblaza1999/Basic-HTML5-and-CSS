...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="#">DEVoPS</a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href="#contact">Contact</a></li>
           <li>||</li>
           <li><a href="{{ route('login') }}"><b><i>Login</i></b></a></li>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="500">
      ...
      <h2>This related to my portfolio project</h2>
      <a href="#abouts" class="btn-get-started scrollto">Get Started</a>
    </div>
  </section><!-- End Hero -->
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
            <h3>About Us</h3>
            <p class="font-italic">
              This site is all about for my portfolio or project done as
            </p>
            <ul>
              <li><i class="icofont-check-circled"></i> Software Implementer</li>
              <li><i class="icofont-check-circled"></i> Software Developer</li>
              <li><i class="icofont-check-circled"></i> Graphic Designer</li>
            </ul>
            <p>
        ...
        <div class="row" data-aos="fade-up">
          <div class="col-lg-6">
            <div class="info-box mb-4">
              <i class="bx bx-map"></i>
              <h3>My Address</h3>
              <p>Cruzan Bulacao Talisay City, Cebu</p>
            </div>
          </div>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="footer-info">
              ...
              <p>
                Cruzan <br>
                Talisay City, Cebu<br><br>
                <strong>Phone:</strong> +639664130327<br>
                <strong>Email:</strong> dbyamyamin@gmail.com<br>
              </p>
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <p>Please subscribe this site to get tune in every post.</p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>DEVoPS</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
